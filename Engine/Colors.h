...
namespace Colors
{
	...
	//baby shark TODODODO
	static constexpr Color MakeARGB(unsigned char a, unsigned char r, unsigned char g, unsigned char b)//baby shark TODODODO
	{
	...
	static constexpr Color CocoaBean = MakeRGB(111u, 55u, 55u);
	static constexpr Color Brown = MakeRGB( 197u,146u,129u );
	static constexpr Color Green = MakeRGB( 11u,171u,112u );
	static constexpr Color DarkGreen = MakeRGB(38u, 67u, 38u);
	...
	static constexpr Color DarkBlue = MakeRGB(0u, 0u, 75u);
